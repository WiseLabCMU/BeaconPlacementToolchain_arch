function [PtsInFp] = GetAllPointsInFloorPlan(FloorPlanDataPath,GridSize,F_SaveResToPath,AddnPotentialBeacLoc)
...
%inside the obstacle Corners.
    ...
    if F_SaveResToPath==1
        save(fullfile(FloorPlanDataPath,'FloorPlanPtsInfo.mat'),'PtsInFp','AllCornerObsPos','FloorPlanPoly','GridSize');
    end
